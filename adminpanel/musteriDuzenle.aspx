<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/master_admin.master" AutoEventWireup="true" CodeFile="musteriDuzenle.aspx.cs" Inherits="adminpanel_musteriDuzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <table class="auto-style1" style="padding-top: 10px; padding-left: 10px">
            ...
            <td class="auto-style2" style="padding-top: 10px">
                ...
                <tr>
                    ...
                    <td class="auto-style6" style="padding-top: 10px">
                        <asp:DropDownList ID="ddlMahalle" runat="server">
                        </asp:DropDownList>
                    </td>
        ...
        <tr>
            ...
            <td style="padding-top: 10px">
                <%--<asp:Button class="btn btn-primary" ID="btnMusteriKaydet" runat="server" Text="Güncelle" Width="120px" OnClick="btnMusteriKaydet_Click" />--%>
            </td>
            <td style="padding-top: 10px">&nbsp;</td>
        </tr>
        <tr>
